...
# * https://github.com/samwhelp/note-about-bspwm/blob/gh-pages/_demo/project/bspwmrc-profile/bspwmrc-ctrl/remote-install.sh
# * https://github.com/samwhelp/note-about-bspwm/blob/gh-pages/_demo/project/bspwmrc-profile/bspwmrc-ctrl/bspwmrc-ctrl
# * https://raw.githubusercontent.com/samwhelp/note-about-bspwm/gh-pages/_demo/project/bspwmrc-profile/bspwmrc-ctrl/bspwmrc-ctrl
...
## $ export DEBUG_BSPWMRC_CTRL_INSTALL=true
is_debug () {
	if [ "$DEBUG_BSPWMRC_CTRL_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="bspwmrc-ctrl-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-bspwm/blob/gh-pages/_demo/project/bspwmrc-profile/bspwmrc-ctrl/bspwmrc-ctrl
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-bspwm/gh-pages/_demo/project/bspwmrc-profile/bspwmrc-ctrl/bspwmrc-ctrl'


	THE_TARGET_FILE_NAME="bspwmrc-ctrl"
